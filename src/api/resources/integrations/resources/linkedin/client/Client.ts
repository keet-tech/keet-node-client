...
export class Linkedin {
     ...
     *
     * @param {Keet.integrations.GetConnections} request
     * @param {Linkedin.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Keet.common.UnAuthorizedError}
     * @throws {@link Keet.common.InternalServerError}
    ...
    public async getConnections(
        ...
        requestOptions?: Linkedin.RequestOptions
    ): Promise<Keet.integrations.GetConnectionsResult> {
        ...
        const _response = await core.fetcher({
            url: urlJoin(environments.KeetEnvironment.Production, "/v1/linkedin/connections"),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "X-Account-Token":
