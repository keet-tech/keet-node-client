...
export class X {
     ...
     *
     * @param {Keet.integrations.GetXFollowingPosts} request
     * @param {X.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Keet.common.UnAuthorizedError}
     * @throws {@link Keet.common.InternalServerError}
     ...
     *     })
     */
    public async getFollowingTweets(
        request: Keet.integrations.GetXFollowingPosts = {},
        requestOptions?: X.RequestOptions
    ): Promise<Keet.integrations.GetXFollowingTweetsResponse> {
        const { limit } = request;
        const _queryParams: Record<string, string | string[] | object | object[]> = {};
        if (limit != null) {
            _queryParams["limit"] = limit.toString();
        ...
        const _response = await core.fetcher({
            url: urlJoin(environments.KeetEnvironment.Production, "/v1/x/posts/following"),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "X-Account-Token":
        ...
        if (_response.ok) {
            return serializers.integrations.GetXFollowingTweetsResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],
