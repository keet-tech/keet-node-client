...
export class Toast {
    constructor(protected readonly _options: Toast.Options) {}
     ...
     *
     * @param {Toast.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public async createSession(requestOptions?: Toast.RequestOptions): Promise<Keet.common.CreateSessionResponse> {
        const _response = await core.fetcher({
            url: urlJoin(environments.KeetEnvironment.Production, "/v1/toast/session"),
            method: "POST",
            headers: {
     ...
     */
    public async getMenu(requestOptions?: Toast.RequestOptions): Promise<Keet.integrations.GetMenusResponse> {
        const _response = await core.fetcher({
            url: urlJoin(environments.KeetEnvironment.Production, "/v1/toast/menus"),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "X-Account-Token":
        ...
        if (_response.ok) {
            return serializers.integrations.GetMenusResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],
