...
export class Venmo {
     ...
     */
    public async createSession(requestOptions?: Venmo.RequestOptions): Promise<KeetApi.common.CreateSessionResponse> {
    ...
    ): Promise<KeetApi.integrations.GetTransactionsResponse> {
        const _response = await core.fetcher({
