...
export class DoorDash {
     ...
     */
    public async createSession(requestOptions?: DoorDash.RequestOptions): Promise<Keet.common.CreateSessionResponse> {
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "/v1/doordash/session"),
            method: "POST",
            headers: {
